...
--
-- Host: 127.0.0.1
-- Czas generowania: 03 Mar 2018, 23:17
...
INSERT INTO `reservations` (`ID`, `User_ID`, `House`, `Bookfrom`, `Bookto`, `Status`, `Edited`, `price`) VALUES
(1, 1, 2, '2018-02-04', '2018-02-07', 'Paid', 0, 0),
(2, 1, 3, '2018-02-12', '2018-02-22', 'paid', 1, 0),
(3, 1, 2, '2018-03-10', '2018-03-15', '', NULL, 0),
(7, 4, 3, '2018-04-21', '2018-04-23', 'unpaid', NULL, 0),
(9, 6, 2, '2018-04-01', '2018-04-20', 'unpaid', NULL, 0);
...
--
ALTER TABLE `reservations`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID rezerwacji', AUTO_INCREMENT=10;
--
